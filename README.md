...
-   `datasets.js`
    ...
    From this you can add your datasets to the web application.

    Instructions:

    -   Add new dataset

        1. Create a new function starts with `dataset_`. For example you can add new function named `dataset_3`.
        ...
        3. In the last lines you will see an array to which you need to add your new `datasets` function.
